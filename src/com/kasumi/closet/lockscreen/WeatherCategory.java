...
package com.kasumi.closet.lockscreen;
...
public class WeatherCategory extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.kasumi_weather);
    ...
    private boolean isOmniJawsServiceInstalled() {
         return kasumiUtils.isPackageInstalled(getActivity(), WEATHER_SERVICE_PACKAGE);
     }
