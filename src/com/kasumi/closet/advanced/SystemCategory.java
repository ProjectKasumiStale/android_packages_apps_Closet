...
package com.kasumi.closet.advanced;
...
public class SystemCategory extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_KASUMI_SETTINGS_SUMMARY = "kasumi_settings_summary";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.kasumi_system);
        ...
        mCustomSummary = (Preference) prefScreen.findPreference(PREF_KASUMI_SETTINGS_SUMMARY);
            ...
            alert.setPositiveButton(getString(android.R.string.ok),
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Settings.System.putString(resolver, Settings.System.KASUMI_SETTINGS_SUMMARY, value);
                            updateCustomSummaryTextString();
                        }
                    });
    ...
    private void updateCustomSummaryTextString() {
        mCustomSummaryText = Settings.System.getString(
                getActivity().getContentResolver(), Settings.System.KASUMI_SETTINGS_SUMMARY);

        if (TextUtils.isEmpty(mCustomSummaryText)) {
            mCustomSummary.setSummary(R.string.closet_summary_title);
        } else {
